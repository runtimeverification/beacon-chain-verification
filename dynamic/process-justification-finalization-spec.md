...
//
/// andBool ?Epoch2LastJustifiedEpoch ==Int LastJustifiedMap[Epoch2]i
/// andBool ?Epoch1LastJustifiedEpoch ==Int LastJustifiedMap[Epoch1]i
/// andBool   ?PrevLastJustifiedEpoch ==Int LastJustifiedMap[Epoch]i
//
/// andBool ?Epoch1LastFinalizedEpoch ==Int LastFinalizedMap[Epoch1]i
/// andBool   ?PrevLastFinalizedEpoch ==Int LastFinalizedMap[Epoch]i
//
// invariant
//
...
//
/// andBool ?NewLastJustifiedEpoch ==Int ?NewLastJustifiedMap[Epoch]i
/// andBool ?NewLastFinalizedEpoch ==Int ?NewLastFinalizedMap[Epoch]i
//
// ensures
//
