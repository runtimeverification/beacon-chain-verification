...
(* A validator may not make two votes with different target hashes at the   *)
(* same target height (whatever the source blocks)                          *)
...
(* A validator may not make two votes with the source and target of one     *)
(* vote both strictly between the source and target of the other            *)
